    ...
    <div class= change_box>
        ...
        <div class="row">
            ...
            <table align="center">
                ...
                <tr height="50">
                <td style="background-color:blueviolet; color:white">Confirm Passowrd :</td>
            ...
            if ($oldpass != $newpassword){
                ...
                if (preg_match($pattern, $newpassword)){
                    ...
                    if ($confirmpassword == $newpassword){
                        ...
                        echo"<script> alert('New password and Confirm Password must be same !!!'); window.location.href = 'tutor.php?tutor_change_pass_form' </script>";
                    }
                } else {
