<!-- admin login page and check for all the validation in filling the form -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <title>MYstudy Admin Login Page</title>
...
<body>
    ...
    <div class="header-container">
        <header>
            <div class="logo">
                ...
                <span style="color:skyblue">Admin Panel</span>
            </div>
            <nav>
    ...
    <div class="container">
        ...
        <div class="box" id="loginbox">
            ...
            <div id="loginform">
                <form name="login_form" method="post" action="at_login_form.php" enctype="multipart/form-data">
                    ...
                    <div>
                        <input type="submit" value="Log in" class="login" id="loginbutton" name="aloginbutton">
                    </div>
        ...
        <div class="box" id="registerbox">
            ...
            <form id="registerform" method="post" action="at_register_form.php" onSubmit="return confirm('Do you make sure all the inforamtion are correct and submit?')" enctype="multipart/form-data">
                ...
                <fieldset>
                    ...
                    <input type="submit" value="Sign Up" class="register" id="signupbutton" name="asingupbutton">
                </fieldset>
            </form>
        </div>
    </div>
