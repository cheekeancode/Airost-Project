...
<body>
    <!-- These are the element and input for add course form  -->
            <div class="container">
                <div class="jumbotron">
                    <div class="row">
                        <div class="col-md-12">
...
// These are for the user when unsuccessfully submit, then redict back to the form and the input field shown corresponding to the slected value before
...
// show and hide number of input fields depends on selecting number of lesson 
