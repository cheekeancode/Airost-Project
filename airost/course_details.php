...
<body>
    ...
    <div class="container">
        ...
        ?>
            ...
            <div class=box>
                <div class="row">
                    <div class="column" style="padding-right:80px; width:100%">
                        <h1 style="margin-bottom: 0px;"> Course Field: <br> <h1 style="color:darkblue; padding-top:0px;"> <?php echo $row['c_field']?> </h1> </h1>
                        <h1 style="margin-bottom: 0px;"> Course Name: <br><h1 style="color:darkblue"><?php echo $row['c_name']?></h1></h1>
                        <h1 style="margin-bottom: 0px;"> Course Level: <h1 style="color:darkblue"><?php echo $row['c_level']?></h1></h1>
                        <h1 style="margin-bottom: 0px;"> Instructor: <br><h1 style="color:darkblue"><?php echo $row['tutor']?></h1></h1>
                    </div>
                    <div class="column" style="border-left: purple 3px solid; width:100%; float:right;">
                        <h1> Course Description: <br><h2 style="white-space:pre-wrap;color:darkblue;"><?php echo $row['c_description']?></h2></h1><hr style="border: solid 1px purple; width: 92%">
                        <h1 style="margin-top:20px"> Course Outcome: <br><h2 style="color:darkblue;"><?php echo $row['c_outcome']?></h2></h1>
    
                    </div>   
                </div>
              
                <div>
                <hr style="border: solid 1px purple; width: 100%;">
