<?php
    ...
    // when create button on add course form clicked
    if(isset($_POST['create'])){
        ...
        // Commonly, this is validation that the user require to fill the input field depends on selected number of lesson, if all validation met successfully add the course and save to database 
        if ($lesson == "1"){
            ...
            if(empty($title1) && empty($message1) && empty($link1)){
                ...
                $query = "INSERT INTO course (tutor, c_field, c_name, c_level, c_description, c_outcome, lesson, title1, message1, link1, title2, message2, link2, title3, message3, link3, title4, message4, link4, title5, message5, link5) VALUES ('$tutor', '$c_field',	'$c_name', '$c_level', '$c_description', '$c_outcome', '$lesson', '$title1', '$message1', '$link1',	'$title2', '$message2',	'$link2', '$title3', '$message3', '$link3',	'$title4', '$message4',	'$link4', '$title5', '$message5', '$link5')";
