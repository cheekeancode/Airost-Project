        ...
        case 1:
            ...
            if(($("input[name='nationality']:checked").length === 0)){
                ...
                if(err.length > 0 && document.getElementById('malaysian').checked) {
                    alert('Please fill in IC number and upload a proven picture');
                    document.getElementById('upload').animate([{background:'red'}], {duration:900});
                    err.push('Please Enter Your '+id);
                    return false;
                    } else if(document.getElementById('malaysian').checked && (!document.getElementById('ICnum').value.match(/^[0-9]+$/) || document.getElementById('ICnum').value.length != 12)){
...
function yesno(){
    if (document.getElementById('nonmalaysian').checked){
        ...
        document.getElementById('proceed').style.display='none';
        document.getElementById('period').style.display='block';
        document.getElementById('mfee').style.textDecoration='line-through';
        document.getElementById('yfee').style.textDecoration='line-through';
