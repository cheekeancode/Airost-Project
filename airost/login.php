...
<head>
    ...
    <title>MYstudy User Login Page</title>
                            ...
                            <div class="period" id="period">
                                ...
                                <div class= "monthly">
                                    <label for="monthly">
                                        ...
                                        <p name="period" id="monthly">Monthly Subcription<br>Fees: <span id="mfee">RM30  </span><span id="offer1">  RM10  </span><span id="dis1" style="color:red;">(discount: 60%)</span></p>
                                    </label>
                                </div>
                                <div class="yearly">
                                <label for="yearly">
                                    <input type="radio" name="period" id="yearly" value="yearly" style="display:none" required>
                                    <p>Yearly Subcription<br>Fees: <span id="yfee">RM100  </span><span id="offer2">  RM30  </span><span id="dis2" style="color:red;">  (discount: 70%)</span></p>
                                </label>
                                </div>
                            </div>
                            <div class="period1" id="period1" style="display:none">
                            </div>
                        </div>
